...
<div class="row center-align">
    <div class="col s12 m6 l3">
        <img class="responsive-img" src="iamges/apie1.jpg" alt="nuotrauka1">
        <h6>Nuotraukos tekstas</h6>
    </div>
    <div class="col s12 m6 l3">
        <img class="responsive-img" src="iamges/apie2.jpg" alt="nuotrauka2">
        <h6>Nuotraukos tekstas</h6>
    </div>
    <div class="col s12 m6 l3">
        <img class="responsive-img" src="iamges/apie3.jpg" alt="nuotrauka3">
        <h6>Nuotraukos tekstas</h6>
    </div>
    <div class="col s12 m6 l3">
        <img class="responsive-img" src="iamges/apie4.jpg" alt="nuotrauka4">
        <h6>Nuotraukos tekstas</h6>
    </div>
